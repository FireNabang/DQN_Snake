...
def main():
    training_data, test_data = load_mnist.load_data(train_data_cnt=2000, test_data_cnt=1000, shape='matrix')
    ...
    model.add_layer(Conv2DLayer(filter_count=10, filter_size=(2, 2), activations='relu'))
    model.add_layer(MaxPooling2DLayer(pool_size=(2, 2)))
